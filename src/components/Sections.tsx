...
export function OpenSource() {
  return (
    <Shell id="open-source">
      ...
      <p className="text-muted-foreground max-w-2xl mb-10 reveal">
        Six bugs I found and fixed in tools a lot of people build on, across Pydantic, LiteLLM, Haystack, LlamaIndex, and DSPy.
        Four merged, two in review. I care less about line count and more about catching the second broken file nobody noticed.
      </p>
      <div className="grid md:grid-cols-2 gap-5">
        {openSource.map((o, i) => (
