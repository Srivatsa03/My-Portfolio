...
export function CommandPalette({ posts }: CommandPaletteProps) {
    ...
    const copyEmail = useCallback(async () => {
        try {
            await navigator.clipboard.writeText("srivatsakamballa02@gmail.com");
            setCopied(true);
            setTimeout(() => setCopied(false), 1500);
        } catch {
            window.location.href = "mailto:srivatsakamballa02@gmail.com";
        }
    }, []);
                    ...
                    <Command.List className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-2">
                        ...
                        <Group heading="Actions">
                            <Item
                                ...
                                sublabel="srivatsakamballa02@gmail.com"
                        ...
                        <Group heading="External">
                            <Item
                                ...
                                label="GitHub"
                                sublabel="github.com/Srivatsa03"
                                onSelect={() =>
                                    run(() =>
                                        window.open(
                                            "https://github.com/Srivatsa03",
                                            "_blank",
                                            "noopener,noreferrer",
                                        ),
                                    )
                            ...
                            <Item
                                ...
                                label="LinkedIn"
                                sublabel="linkedin.com/in/srivatsa-kamballa"
                                onSelect={() =>
                                    run(() =>
                                        window.open(
                                            "https://www.linkedin.com/in/srivatsa-kamballa/",
                                            "_blank",
                                            "noopener,noreferrer",
                                        ),
                                    )
                                ...
                                onSelect={() =>
                                    run(() => {
                                        window.location.href =
                                            "mailto:srivatsakamballa02@gmail.com";
                                    })
                                }
                            />
                            <Item
