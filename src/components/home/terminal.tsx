...
const QUOTES: string[][] = [
  ...
  ["recruiter: 'any production experience?'  →  10 PRs merged into libraries you imported this morning."],
  ...
  ["impostor syndrome? I have a patent, an AWS cert, and 10 merged PRs. the impostor is thriving, honestly."],
